...
export default function GlowyBorder({ children }: GlowyBorderProps) {
  ...
  return (
    <motion.div
      className="relative lg:max-w-screen-sm md:max-w-lg sm:max-w-96 rounded-lg shrink-0 w-full max-w-72"
    ...
    >
      ...
      />
      <div className="relative bg-transparent rounded-lg">{children}</div>
    </motion.div>
  );
}
